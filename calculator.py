...
window = Tk()
# size of the window width:- 500, height:- 375
...
input_filed = Entry(input_frame, font=(
    'arial', 18, 'bold'), textvariable=input_text, width=50, bg='#eee', bd=0, justify=RIGHT)
...
clear = Button(btns_frame, text='C', fg='black', width=32, height=3,
               bd=0, bg='#eee', cursor='hand2', command=lambda: btn_clear()).grid(row=0, column=0, columnspan=3, padx=1, pady=1)
...
eight = Button(btns_frame, text='8', fg='black', width=10, height=3, bd=0,
               bg='#fff', cursor='hand2', command=lambda: btn_click(8)).grid(row=1, column=1, padx=1, pady=1)
...
multiply = Button(btns_frame, text='*', fg='black', width=10, height=3, bd=0, bg='#fff',
